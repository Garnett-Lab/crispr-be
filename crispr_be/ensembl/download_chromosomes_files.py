...
def main(cfg: DictConfig) -> None:
    base_url = cfg.chr_fasta_download_url
    chromosomes = cfg.chromosomes
    output_dir = Path(cfg.grch38_dirpath)
    ...
    # Download nonchromosomal file
    nonchrom_filename = "Homo_sapiens.GRCh38.dna.nonchromosomal.fa.gz"
    nonchrom_url = f"{base_url}{nonchrom_filename}"
    nonchrom_output_path = output_dir / nonchrom_filename
    download_and_extract(nonchrom_url, nonchrom_output_path)
